        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Classified'),
                        'icon' => '<i class="fa fa-th-list"></i>',
                        'url' => ['#'],
                        'options' => ['class' => 'treeview'],
                        'items' => [
                            ['label' => 'Review Classified', 'icon' => '', 'url' => ['/review-classified/'], 'active' => Yii::$app->controller->id == 'review-classified'],
                            ['label' => 'Featured', 'icon' => '', 'url' => ['/featured-classified/'], 'active' => Yii::$app->controller->id == 'featured-classified'],
                    ...
                    [
                        ...
                        'options' => ['class' => 'treeview'],
                        'items' => [
                            ['label' => 'Main Category', 'icon' => '', 'url' => ['/main-category/'], 'active' => Yii::$app->controller->id == 'main-category'],
                            ['label' => 'Sub Category', 'icon' => '', 'url' => ['/category/'], 'active' => Yii::$app->controller->id == 'category'],
