    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#flaticons" data-toggle="tab">FlatIcons</a></li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane" id="flaticons">

                    <ul class="flaticons">
                        <li><i class="flaticon--01-userinterface-trash"></i> flaticon--01-userinterface-trash</li>
                        <li><i class="flaticon--02-userinterface-note"></i> flaticon--02-userinterface-note</li>
                        <li><i class="flaticon--03-userinterface-unloack"></i> flaticon--03-userinterface-unloack</li>
                        <li><i class="flaticon--04-userinterface-uploads"></i> flaticon--04-userinterface-uploads</li>
                        <li><i class="flaticon-userinterface-time-3"></i> flaticon-userinterface-time-3</li>
                        <li><i class="flaticon-userinterface-tick"></i> flaticon-userinterface-tick</li>
                        <li><i class="flaticon-userinterface-settings"></i> flaticon-userinterface-settings</li>
                        <li><i class="flaticon-userinterface-settings-ui"></i> flaticon-userinterface-settings-ui</li>
                        <li><i class="flaticon-userinterface-setting-roll"></i> flaticon-userinterface-setting-roll</li>
                        <li><i class="flaticon-userinterface-search-53"></i> flaticon-userinterface-search-53</li>
                        <li><i class="flaticon-userinterface-report-flag"></i> flaticon-userinterface-report-flag</li>
                        <li><i class="flaticon-userinterface-open-64"></i> flaticon-userinterface-open-64</li>
                        <li><i class="flaticon-userinterface-minuse-page"></i> flaticon-userinterface-minuse-page</li>
                        <li><i class="flaticon-userinterface-mail-open"></i> flaticon-userinterface-mail-open</li>
                        <li><i class="flaticon-userinterface-mail-67"></i> flaticon-userinterface-mail-67</li>
                        <li><i class="flaticon-userinterface-mail-61"></i> flaticon-userinterface-mail-61</li>
                        <li><i class="flaticon-userinterface-locate"></i> flaticon-userinterface-locate</li>
                        <li><i class="flaticon-userinterface-loack49"></i> flaticon-userinterface-loack49</li>
                        <li><i class="flaticon-userinterface-load"></i> flaticon-userinterface-load</li>
                        <li><i class="flaticon-userinterface-image"></i> flaticon-userinterface-image</li>
                        <li><i class="flaticon-userinterface-drag"></i> flaticon-userinterface-drag</li>
                        <li><i class="flaticon-userinterface-favorite"></i> flaticon-userinterface-favorite</li>
                        <li><i class="flaticon-userinterface-drawer-1"></i> flaticon-userinterface-drawer-1</li>
                        <li><i class="flaticon-userinterface-comment"></i> flaticon-userinterface-comment</li>
                        <li><i class="flaticon-userinterface-downloads"></i> flaticon-userinterface-downloads</li>
                        <li><i class="flaticon-userinterface-close-page-89"></i> flaticon-userinterface-close-page-89</li>
                        <li><i class="flaticon-userinterface-clock"></i> flaticon-userinterface-clock</li>
                        <li><i class="flaticon-userinterface-browser-close"></i> flaticon-userinterface-browser-close</li>
                        <li><i class="flaticon-userinterface-browser-minus"></i> flaticon-userinterface-browser-minus</li>
                        <li><i class="flaticon-userinterface-browser-check"></i> flaticon-userinterface-browser-check</li>
                        <li><i class="flaticon-userinterface-browser-add"></i> flaticon-userinterface-browser-add</li>
                        <li><i class="flaticon-userinterface-bookmarks"></i> flaticon-userinterface-bookmarks</li>
                        <li><i class="flaticon-userinterface-bookmark"></i> flaticon-userinterface-bookmark</li>
                        <li><i class="flaticon-userinterface-add-page"></i> flaticon-userinterface-add-page</li>
                        <li><i class="flaticon-userinterface-abacuse"></i> flaticon-userinterface-abacuse</li>
                        <li><i class="flaticon-user-interaction-review-verticle-bars"></i> flaticon-user-interaction-review-verticle-bars</li>
                        <li><i class="flaticon-user-interaction-review-view-user"></i> flaticon-user-interaction-review-view-user</li>
                        <li><i class="flaticon-user-interaction-review-user"></i> flaticon-user-interaction-review-user</li>
                        <li><i class="flaticon-user-interaction-review-unview-user"></i> flaticon-user-interaction-review-unview-user</li>
                        <li><i class="flaticon-user-interaction-review-unlock-user"></i> flaticon-user-interaction-review-unlock-user</li>
                        <li><i class="flaticon-user-interaction-review-unlock-user-rd"></i> flaticon-user-interaction-review-unlock-user-rd</li>
                        <li><i class="flaticon-user-interaction-review-success-user"></i> flaticon-user-interaction-review-success-user</li>
                        <li><i class="flaticon-user-interaction-review-star-user"></i> flaticon-user-interaction-review-star-user</li>
                        <li><i class="flaticon-user-interaction-review-settings-user"></i> flaticon-user-interaction-review-settings-user</li>
                        <li><i class="flaticon-user-interaction-review-search-user"></i> flaticon-user-interaction-review-search-user</li>
                        <li><i class="flaticon-user-interaction-review-remove-user-03"></i> flaticon-user-interaction-review-remove-user-03</li>
                        <li><i class="flaticon-user-interaction-review-remove-user-02"></i> flaticon-user-interaction-review-remove-user-02</li>
                        <li><i class="flaticon-user-interaction-review-notify-user"></i> flaticon-user-interaction-review-notify-user</li>
                        <li><i class="flaticon-user-interaction-review-mail-user"></i> flaticon-user-interaction-review-mail-user</li>
                        <li><i class="flaticon-user-interaction-review-lock-user"></i> flaticon-user-interaction-review-lock-user</li>
                        <li><i class="flaticon-user-interaction-review-edit-user"></i> flaticon-user-interaction-review-edit-user</li>
                        <li><i class="flaticon-user-interaction-review-lock-user-rd"></i> flaticon-user-interaction-review-lock-user-rd</li>
                        <li><i class="flaticon-user-interaction-review-favorite-user-rd"></i> flaticon-user-interaction-review-favorite-user-rd</li>
                        <li><i class="flaticon-user-interaction-review-favorite-user"></i> flaticon-user-interaction-review-favorite-user</li>
                        <li><i class="flaticon-user-interaction-review-delete-user"></i> flaticon-user-interaction-review-delete-user</li>
                        <li><i class="flaticon-user-interaction-review-delete-user-rd"></i> flaticon-user-interaction-review-delete-user-rd</li>
                        <li><i class="flaticon-user-interaction-review-call-user"></i> flaticon-user-interaction-review-call-user</li>
                        <li><i class="flaticon-user-interaction-review-bookmark-user"></i> flaticon-user-interaction-review-bookmark-user</li>
                        <li><i class="flaticon-user-interaction-review-block-user"></i> flaticon-user-interaction-review-block-user</li>
                        <li><i class="flaticon-user-interaction-review-bookmark-user-rd-36"></i> flaticon-user-interaction-review-bookmark-user-rd-36</li>
                        <li><i class="flaticon-user-interaction-review-add-user-rd"></i> flaticon-user-interaction-review-add-user-rd</li>
                        <li><i class="flaticon-sociai-icons-youtube"></i> flaticon-sociai-icons-youtube</li>
                        <li><i class="flaticon-sociai-icons-whatsapp"></i> flaticon-sociai-icons-whatsapp</li>
                        <li><i class="flaticon-sociai-icons-vimeo"></i> flaticon-sociai-icons-vimeo</li>
                        <li><i class="flaticon-sociai-icons-twitter-73"></i> flaticon-sociai-icons-twitter-73</li>
                        <li><i class="flaticon-sociai-icons-twitter-74"></i> flaticon-sociai-icons-twitter-74</li>
                        <li><i class="flaticon-sociai-icons-tumblr12"></i> flaticon-sociai-icons-tumblr12</li>
                        <li><i class="flaticon-sociai-icons-pininterest-88"></i> flaticon-sociai-icons-pininterest-88</li>
                        <li><i class="flaticon-sociai-icons-linkedin"></i> flaticon-sociai-icons-linkedin</li>
                        <li><i class="flaticon-sociai-icons-map"></i> flaticon-sociai-icons-map</li>
                        <li><i class="flaticon-sociai-icons-linkedin-1"></i> flaticon-sociai-icons-linkedin-1</li>
                        <li><i class="flaticon-sociai-icons-instagram"></i> flaticon-sociai-icons-instagram</li>
                        <li><i class="flaticon-sociai-icons-google-91"></i> flaticon-sociai-icons-google-91</li>
                        <li><i class="flaticon-sociai-icons-google-38"></i> flaticon-sociai-icons-google-38</li>
                        <li><i class="flaticon-sociai-icons-facebook-28"></i> flaticon-sociai-icons-facebook-28</li>
                        <li><i class="flaticon-sociai-icons-facebook-21"></i> flaticon-sociai-icons-facebook-21</li>
                        <li><i class="flaticon-sociai-icons-baidu"></i> flaticon-sociai-icons-baidu</li>
                        <li><i class="flaticon-household-round-clock"></i> flaticon-household-round-clock</li>
                        <li><i class="flaticon-household-pan"></i> flaticon-household-pan</li>
                        <li><i class="flaticon-household-frame"></i> flaticon-household-frame</li>
                        <li><i class="flaticon-household-clock-block"></i> flaticon-household-clock-block</li>
                        <li><i class="flaticon-gesture-finger-press"></i> flaticon-gesture-finger-press</li>
                        <li><i class="flaticon-games-entertainment-archery-2"></i> flaticon-games-entertainment-archery-2</li>
                        <li><i class="flaticon-games-entertainment-football"></i> flaticon-games-entertainment-football</li>
                        <li><i class="flaticon-games-entertainment-archery-1"></i> flaticon-games-entertainment-archery-1</li>
                        <li><i class="flaticon-finance-shopping-dollars"></i> flaticon-finance-shopping-dollars</li>
                        <li><i class="flaticon-document-folder-user"></i> flaticon-document-folder-user</li>
                        <li><i class="flaticon-document-folder-download-67"></i> flaticon-document-folder-download-67</li>
                        <li><i class="flaticon-document-folder-download-68"></i> flaticon-document-folder-download-68</li>
                        <li><i class="flaticon-document-folder-board-minus"></i> flaticon-document-folder-board-minus</li>
                        <li><i class="flaticon-document-folder-doc"></i> flaticon-document-folder-doc</li>
                        <li><i class="flaticon-document-folder-board-edit"></i> flaticon-document-folder-board-edit</li>
                        <li><i class="flaticon-document-folder-board-close"></i> flaticon-document-folder-board-close</li>
                        <li><i class="flaticon-document-folder-board-check"></i> flaticon-document-folder-board-check</li>
                        <li><i class="flaticon-document-folder-board-add"></i> flaticon-document-folder-board-add</li>
                        <li><i class="flaticon-document-folder-adobe-acrobat"></i> flaticon-document-folder-adobe-acrobat</li>
                        <li><i class="flaticon-devices-network-large-phone"></i> flaticon-devices-network-large-phone</li>
                        <li><i class="flaticon-devices-network-floppy"></i> flaticon-devices-network-floppy</li>
                        <li><i class="flaticon-devices-network-cloud-up"></i> flaticon-devices-network-cloud-up</li>
                        <li><i class="flaticon-devices-network-cloud-right"></i> flaticon-devices-network-cloud-right</li>
                        <li><i class="flaticon-devices-network-cloud-close"></i> flaticon-devices-network-cloud-close</li>
                        <li><i class="flaticon-devices-network-cam-4"></i> flaticon-devices-network-cam-4</li>
                        <li><i class="flaticon-devices-network-cam-2"></i> flaticon-devices-network-cam-2</li>
                        <li><i class="flaticon-devices-network-cam-1-25"></i> flaticon-devices-network-cam-1-25</li>
                        <li><i class="flaticon-devices-network-cam-1-11"></i> flaticon-devices-network-cam-1-11</li>
                        <li><i class="flaticon-devices-network-ii-check-file"></i> flaticon-devices-network-ii-check-file</li>
                        <li><i class="flaticon-devices-network-ii-bookmark-file"></i> flaticon-devices-network-ii-bookmark-file</li>
                        <li><i class="flaticon-design-trash"></i> flaticon-design-trash</li>
                        <li><i class="flaticon-design-square"></i> flaticon-design-square</li>
                        <li><i class="flaticon-design-star"></i> flaticon-design-star</li>
                        <li><i class="flaticon-celebration-holidays-ship"></i> flaticon-celebration-holidays-ship</li>
                        <li><i class="flaticon-celebration-holidays-bag-2"></i> flaticon-celebration-holidays-bag-2</li>
                        <li><i class="flaticon-buildings-14"></i> flaticon-buildings-14</li>
                        <li><i class="flaticon-celebration-holidays-candles-44"></i> flaticon-celebration-holidays-candles-44</li>
                        <li><i class="flaticon-office-56"></i> flaticon-office-56</li>
                        <li><i class="flaticon-buildings-05"></i> flaticon-buildings-05</li>
                        <li><i class="flaticon-buildings-04"></i> flaticon-buildings-04</li>
                        <li><i class="flaticon-office-51"></i> flaticon-office-51</li>
                        <li><i class="flaticon-office-22"></i> flaticon-office-22</li>
                        <li><i class="flaticon-office-40"></i> flaticon-office-40</li>
                        <li><i class="flaticon-office-39"></i> flaticon-office-39</li>
                        <li><i class="flaticon-office-19"></i> flaticon-office-19</li>
                        <li><i class="flaticon-office-05"></i> flaticon-office-05</li>
                        <li><i class="flaticon-office-01"></i> flaticon-office-01</li>
                        <li><i class="flaticon-map-and-locations-map-locate-3"></i> flaticon-map-and-locations-map-locate-3</li>
                        <li><i class="flaticon-map-and-locations-map-add"></i> flaticon-map-and-locations-map-add</li>
                        <li><i class="flaticon-map-and-locations-locate-5"></i> flaticon-map-and-locations-locate-5</li>
                        <li><i class="flaticon-map-and-locations-locate-4"></i> flaticon-map-and-locations-locate-4</li>
                        <li><i class="flaticon-map-and-locations-loacte"></i> flaticon-map-and-locations-loacte</li>
                        <li><i class="flaticon-map-and-locations-globe"></i> flaticon-map-and-locations-globe</li>
                        <li><i class="flaticon-image-video-shutter"></i> flaticon-image-video-shutter</li>
                        <li><i class="flaticon-map-and-locations-flag-2"></i> flaticon-map-and-locations-flag-2</li>
                        <li><i class="flaticon-map-and-locations-globe-search"></i> flaticon-map-and-locations-globe-search</li>
                        <li><i class="flaticon-map-and-locations-flag-1"></i> flaticon-map-and-locations-flag-1</li>
                        <li><i class="flaticon-image-video-search-file"></i> flaticon-image-video-search-file</li>
                        <li><i class="flaticon-image-video-photos-2"></i> flaticon-image-video-photos-2</li>
                        <li><i class="flaticon-image-video-palyer"></i> flaticon-image-video-palyer</li>
                        <li><i class="flaticon-image-video-paly"></i> flaticon-image-video-paly</li>
                        <li><i class="flaticon-image-video-movie"></i> flaticon-image-video-movie</li>
                        <li><i class="flaticon-image-video-image-file"></i> flaticon-image-video-image-file</li>
                        <li><i class="flaticon-image-video-focus"></i> flaticon-image-video-focus</li>
                        <li><i class="flaticon-image-video-cam"></i> flaticon-image-video-cam</li>
                        <li><i class="flaticon-image-video-cam-3"></i> flaticon-image-video-cam-3</li>
                        <li><i class="flaticon-image-video-cam-1"></i> flaticon-image-video-cam-1</li>
                        <li><i class="flaticon-image-video-board-paper"></i> flaticon-image-video-board-paper</li>
                        <li><i class="flaticon-control-navigation-top-arrow-41"></i> flaticon-control-navigation-top-arrow-41</li>
                        <li><i class="flaticon-editing-verticle-scale"></i> flaticon-editing-verticle-scale</li>
                        <li><i class="flaticon-editing-compress"></i> flaticon-editing-compress</li>
                        <li><i class="flaticon-control-navigation-ii-up-arw"></i> flaticon-control-navigation-ii-up-arw</li>
                        <li><i class="flaticon-control-navigation-ii-right-move"></i> flaticon-control-navigation-ii-right-move</li>
                        <li><i class="flaticon-control-navigation-ii-upload"></i> flaticon-control-navigation-ii-upload</li>
                        <li><i class="flaticon-control-navigation-ii-right-move-2"></i> flaticon-control-navigation-ii-right-move-2</li>
                        <li><i class="flaticon-control-navigation-ii-left-move"></i> flaticon-control-navigation-ii-left-move</li>
                        <li><i class="flaticon-control-navigation-ii-left-move-2"></i> flaticon-control-navigation-ii-left-move-2</li>
                        <li><i class="flaticon-control-navigation-ii-dropdown"></i> flaticon-control-navigation-ii-dropdown</li>
                        <li><i class="flaticon-control-navigation-ii-download"></i> flaticon-control-navigation-ii-download</li>
                        <li><i class="flaticon-control-navigation-top3-arrow"></i> flaticon-control-navigation-top3-arrow</li>
                        <li><i class="flaticon-control-navigation-top2-arrow"></i> flaticon-control-navigation-top2-arrow</li>
                        <li><i class="flaticon-control-navigation-top-arrow-33"></i> flaticon-control-navigation-top-arrow-33</li>
                        <li><i class="flaticon-control-navigation-right3-arrow"></i> flaticon-control-navigation-right3-arrow</li>
                        <li><i class="flaticon-control-navigation-stop-29"></i> flaticon-control-navigation-stop-29</li>
                        <li><i class="flaticon-control-navigation-right2-arrow"></i> flaticon-control-navigation-right2-arrow</li>
                        <li><i class="flaticon-control-navigation-right-arrow-40"></i> flaticon-control-navigation-right-arrow-40</li>
                        <li><i class="flaticon-control-navigation-right-arrow-32"></i> flaticon-control-navigation-right-arrow-32</li>
                        <li><i class="flaticon-control-navigation-reload"></i> flaticon-control-navigation-reload</li>
                        <li><i class="flaticon-control-navigation-pluse-arrow"></i> flaticon-control-navigation-pluse-arrow</li>
                        <li><i class="flaticon-control-navigation-left3-arrow"></i> flaticon-control-navigation-left3-arrow</li>
                        <li><i class="flaticon-control-navigation-left2-arrow"></i> flaticon-control-navigation-left2-arrow</li>
                        <li><i class="flaticon-control-navigation-left-arrow-39"></i> flaticon-control-navigation-left-arrow-39</li>
                        <li><i class="flaticon-control-navigation-left-arrow-31"></i> flaticon-control-navigation-left-arrow-31</li>
                        <li><i class="flaticon-control-navigation-extand-arrow"></i> flaticon-control-navigation-extand-arrow</li>
                        <li><i class="flaticon-control-navigation-down-play"></i> flaticon-control-navigation-down-play</li>
                        <li><i class="flaticon-control-navigation-down3-arrow"></i> flaticon-control-navigation-down3-arrow</li>
                        <li><i class="flaticon-control-navigation-down2-arrow"></i> flaticon-control-navigation-down2-arrow</li>
                        <li><i class="flaticon-control-navigation-down-arrow-42"></i> flaticon-control-navigation-down-arrow-42</li>
                        <li><i class="flaticon-control-navigation-down-arrow-34"></i> flaticon-control-navigation-down-arrow-34</li>
                        <li><i class="flaticon-control-navigation-adjust-lavel"></i> flaticon-control-navigation-adjust-lavel</li>
                        <li><i class="flaticon-control-navigation-anti-reload"></i> flaticon-control-navigation-anti-reload</li>
                        <li><i class="flaticon-control-navigation-control-3"></i> flaticon-control-navigation-control-3</li>
                        <li><i class="flaticon-control-navigation-adjust"></i> flaticon-control-navigation-adjust</li>
                        <li><i class="flaticon-car"></i> flaticon-car</li>
                        <li><i class="flaticon-remove"></i> flaticon-remove</li>
                        <li><i class="flaticon-motorcycle"></i> flaticon-motorcycle</li>
                        <li><i class="flaticon-add-plus-button"></i> flaticon-add-plus-button</li>
                        <li><i class="flaticon-user-black-close-up-shape"></i> flaticon-user-black-close-up-shape</li>
                        <li><i class="flaticon-check-box"></i> flaticon-check-box</li>
                        <li><i class="flaticon-tag-black-shape"></i> flaticon-tag-black-shape</li>
                        <li><i class="flaticon-tags"></i> flaticon-tags</li>
                        <li><i class="flaticon-phone-call"></i> flaticon-phone-call</li>
                        <li><i class="flaticon-google-plus"></i> flaticon-google-plus</li>
                        <li><i class="flaticon-briefcase"></i> flaticon-briefcase</li>
                        <li><i class="flaticon-board"></i> flaticon-board</li>
                    </ul>
                </div>
